...
class PlaylistConfig():
    ...
    m3ugroupnames['ARGENTINA'] = 'other'
    m3ugroupnames['CHILE'] = 'other'
    ...
    m3ugroupnames['fashion'] = 'other'
    m3ugroupnames['none'] = 'other'
    m3ugroupnames['other'] = 'other'
    m3ugroupnames['Other'] = 'other'
    m3ugroupnames['series'] = 'other'
    m3ugroupnames['teleshop'] = 'other'
    m3ugroupnames['tv'] = 'other'
    m3ugroupnames['webcam'] = 'other'
    m3ugroupnames['worldsat'] = 'other'
    m3ugroupnames['Зарубежные'] = 'other'
    m3ugroupnames['Украина'] = 'other'
    m3ugroupnames['עידן פלוס'] = 'other'
    m3ugroupnames['regional'] = 'other'
    m3ugroupnames['religion'] = 'other'
